...
public class KafkaConsumerConfig {
    ...
    // placing order
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Order_DTO> jsonKafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, Order_DTO> factory = new ConcurrentKafkaListenerContainerFactory<>();
    ...
    @Bean
    public DefaultKafkaConsumerFactory<String,Order_DTO> jsonConsumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<>(
                props, new StringDeserializer(), new JsonDeserializer<>(Order_DTO.class)
        );
    ...
    //update order
    @Bean
    public DefaultKafkaConsumerFactory<String,Order_Update> jsonConsumerFactory_update() {
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServers);
        props.put(ConsumerConfig.CLIENT_ID_CONFIG, clientId);
        props.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, autoOffsetReset);
